...
class googlecheck extends StatefulWidget {
  const googlecheck({Key? key}) : super(key: key);

  @override
  State<googlecheck> createState() => _HomeScreenState();
}

class _HomeScreenState extends State<googlecheck> {
